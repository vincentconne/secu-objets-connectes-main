...
try:
    ...
    client.connect("172.16.32.7", 5203) # groupes 1 à 4
...
try:
    client.subscribe("isima/SECRET_1793/G3/#", qos=0)
    client.loop_start()

    """while True:
        (rc, mid) = client.publish(topic="isima/G3", payload="TEST_G3", qos=0)
        print("Error return from publish of mid = " + str(mid) +" : " + mqtt.error_string(rc))
        time.sleep(5)"""

except KeyboardInterrupt:
    client.loop_stop()
    client.unsubscribe("isima/SECRET_1793/G3/#")
    client.disconnect()
    print("Done.")
