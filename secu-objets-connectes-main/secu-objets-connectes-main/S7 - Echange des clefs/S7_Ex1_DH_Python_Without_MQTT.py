...
Alice_private_key = Alice_parameters.generate_private_key() # a new instance of DHPrivateKey
...
Bob_private_key = Bob_parameters.generate_private_key() # a new instance of DHPrivateKey
